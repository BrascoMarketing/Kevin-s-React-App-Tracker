  ...
  return (
    <div>
      ...
      <div className="bg-gray-900 text-white rounded-xl p-4 space-y-4">
        ...
        Average Volume per <span className="text-sm text-green-400 font-bold">{workoutType}</span> Workout: <span className="text-sm text-green-400 font-bold">{Number(averageVolume).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} lbs</span>
      </div>
      </div>
    </div>
  );
